...
python3 -m t5x.train \
  ...
  --gin.OPTAX_MELODI_PATH='"gs://melodi-bucket0/melodi_training/xl-newhyper/task=mnli_mismatched_nodropout_20prompts_cut1500/model=multitoken_base_sequence/horizon=4/memory=6/bsz=512/lr=3e-4/mse=uniform/1684487593/"' \
