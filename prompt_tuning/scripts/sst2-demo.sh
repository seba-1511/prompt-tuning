...
# melodi
MODEL_DIR="gs://melodi-bucket0/melodi_evaluation/debug/debug-switching-posU/task=${FLAN_TASK}/model=xl_nodropout_spot/method=adafactor-melodi-switch64-h16-parameters-gradients-small_multitoken-flan_mnli_cut1000_20prompts_20trajs-h16m4-lr1.0-dp0.0-eval50/${TIME}/"
python3 -m t5x.train \
  ...
  --gin.OPTAX_MELODI_PATH='"gs://melodi-bucket0/melodi_training/xl-newhyper/task=flan_mnli_nodropout_20prompts_20trajs_parampreds_cut1000/model=multitoken_small_sequence_params_grads/horizon=16/memory=4/bsz=512/lr=5e-4/mse=uniform/1687220711"' \
