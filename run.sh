...
./prompt_tuning/scripts/sst2-demo.sh gs://melodi-bucket0/melodi_evaluation/task=mnli_mismatched/model=xl_nodropout_spot/method=precomputed-adafactor-addU-lr1.0-dp0.0/$TIME/ /home/seba-1511/tfds_data
