...
./prompt_tuning/scripts/sst2-demo.sh gs://melodi-bucket0/melodi_evaluation/task=mnli_mismatched/model=xl_nodropout_spot/method=precomputed-melodi-xl_proj1024_train2k-flan10star_cut1500-h4m128-lr1.0-dp0.0-eval1-fix_idx/$TIME/ /home/seba-1511/tfds_data
