...
./prompt_tuning/scripts/sst2-demo.sh gs://melodi-bucket0/melodi_evaluation/task=mnli_mismatched/model=xl_nodropout_spot/method=melodi-gradients-base_multitoken_20prompts-mnli_mismatched_cut1500_350steps-h4m6-lr1.0-dp0.0-eval50-fix_idx/$TIME/ /home/seba-1511/tfds_data
