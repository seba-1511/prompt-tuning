...
./prompt_tuning/scripts/sst2-demo.sh gs://melodi-bucket0/melodi_evaluation/task=mnli_mismatched/model=xl_nodropout_spot/method=melodi-gradients-base_multitoken-flan_mnli_cut1500_20prompts_20trajs-h4m4-lr1.0-dp0.0-eval50/$TIME/ /home/seba-1511/tfds_data
